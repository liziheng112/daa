...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#ftco-navbar" data-offset="200">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a href="#section-home" class="nav-link">点这里</a></li>
            <li class="nav-item"><a href="#section-features" class="nav-link">看目前的人员</a></li>
    ...
    <section class="ftco-cover ftco-slant" style="background-image: url(images/bg_3.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center ftco-vh-100">
          <div class="col-md-10">
            <h1 class="ftco-heading ftco-animate">欢迎来到这里，请在下方填写账号名称和ID</h1>





             <form action="/index/add_do" method="post" enctype="multipart/form-data">
          @csrf
            <h2 class="h5 ftco-subheading mb-5 ftco-animate"> 
              游戏ID：<input type="text" name="game_id">别乱写ok？！
            </h2> 
            <h2 class="h5 ftco-subheading mb-5 ftco-animate"> 
              游戏名字：<input type="text" name="game_name">别乱写，容易乱
            </h2> 
             <p><button target="_blank" class="btn btn-primary ftco-animate">提交</button></p>
           </form>
    ...
    <section class="ftco-section bg-light  ftco-slant ftco-slant-white" id="">
      <div class="container">
    ...
    <section class="ftco-section ftco-slant ftco-slant-light" id="section-features">
      <div class="container">

        <div class="row mb-5">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">About User</h2>
            <div class="row justify-content-center mb-5">
              <link rel="stylesheet" type="text/css" href="{{asset('css/page.css')}}">
              <div class=" ">
      @if($data)
      @foreach($data as $v)
                <p class="lead asss" style="color:#FF3366">队员名称:{{$v->game_name}}<br/>队员名称:{{$v->game_id}}</p>
      @endforeach
      @endif
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md text-left">
            <p>&copy; Exclusivity 2017. All Rights Reserved.  Made with <span class="icon-heart text-danger"></span>  by Free-Template .More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
          </div>
        </div>
      </div>
    </footer>
